...
static void mavlink_test_ina219(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ina219_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.timestamp = packet_in.timestamp;
        packet1.voltageIn = packet_in.voltageIn;
        packet1.currentIn = packet_in.currentIn;
        packet1.powerIn = packet_in.powerIn;
        packet1.voltageOut = packet_in.voltageOut;
        packet1.currentOut = packet_in.currentOut;
        packet1.powerOut = packet_in.powerOut;
    ...
    mavlink_msg_ina219_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ina219_pack(system_id, component_id, &msg , packet1.timestamp , packet1.voltageIn , packet1.currentIn , packet1.powerIn , packet1.voltageOut , packet1.currentOut , packet1.powerOut );
    mavlink_msg_ina219_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ina219_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.voltageIn , packet1.currentIn , packet1.powerIn , packet1.voltageOut , packet1.currentOut , packet1.powerOut );
    mavlink_msg_ina219_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ina219_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ina219_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.voltageIn , packet1.currentIn , packet1.powerIn , packet1.voltageOut , packet1.currentOut , packet1.powerOut );
    mavlink_msg_ina219_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
